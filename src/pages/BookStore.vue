<template>
    ...
    <a-modal v-model:visible="modalVisible" title="เพิ่ม/แก้ไข หนังสือ" @ok="handleOk" okText="บันทึก"
        ...
        <a-row>
            ...
            <a-col :span="18">
                <a-input v-model:value="book.name" placeholder="ชื่อหนังสือ" />
            </a-col>
        </a-row>
        <br />
        <a-row>
            ...
            <a-col :span="18">
                <a-input-number v-model:value="book.price" :min="0" :max="5000" />
            </a-col>
        </a-row>
    </a-modal>
...
let res = await axios.post("http://localhost:3000/books", this.book)
